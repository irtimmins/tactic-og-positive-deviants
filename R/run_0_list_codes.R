...
# of distinct five-character site codes to Data/reference/site_codes_to_lookup.
# csv. That list carries no patient data - it is just codes - so it is safe to
# take off the server to the internet machine, where run_1_internet.R turns it
# into the site-to-trust map.
#
...
message("\nDone. Copy Data/reference/site_codes_to_lookup.csv to the internet ",
