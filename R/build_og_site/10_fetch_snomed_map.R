# =============================================================================
# 10  Fetch the SNOMED to ICD-10 map from TRUD
# -----------------------------------------------------------------------------
# Run this on a machine with internet access. It is not part of the build and
# the analysis server never runs it.
#
...
# 02 reads that file. It replaces having to work the meanings out from the data.
#
# Before running:
