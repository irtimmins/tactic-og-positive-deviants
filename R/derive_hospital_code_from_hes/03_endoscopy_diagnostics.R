...
# explore:
#
#   A  the outcome for every anchored patient, in one place: site read, APC
#      endoscopy on the wrong date, no APC endoscopy record, or not in the
#      extract - the breakdown the "do we need HES-OP" question turns on
